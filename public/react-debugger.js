!function(root, factory) {
    ...
    return function(modules) {
        ...
        var getDataFiber = __webpack_require__(44), _require = __webpack_require__(45), ClassComponent = _require.ClassComponent, FunctionalComponent = _require.FunctionalComponent, ContextConsumer = _require.ContextConsumer, HostRoot = _require.HostRoot, PerformedWork = 1;
              ...
              default:
                ...
                switch (switchValue) {
                  ...
                  case TIMEOUT_SYMBOL_STRING:
                    nodeType = "Special", name = "Timeout", props = fiber.memoizedProps, children = [];
                    break;

                  case PROFILER_NUMBER:
                  case PROFILER_SYMBOL_STRING:
                    nodeType = "Special", props = fiber.memoizedProps, name = "Profiler", children = [];
                    break;
